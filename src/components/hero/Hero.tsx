...
const Hero = () => {
  return (
    <main className="mx-auto container px-5 pt-14 lg:px-10 flex lg:flex-row flex-col lg:justify-between justify-center items-center text-center lg:text-start">
