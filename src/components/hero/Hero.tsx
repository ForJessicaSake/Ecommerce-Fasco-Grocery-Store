...
const Hero = () => {
  return (
    <main
      data-aos="fade-up"
      className="mx-auto container px-5 pt-14 xl:pt-4 lg:px-10 flex lg:flex-row flex-col lg:justify-between justify-center items-center text-center lg:text-start"
    >
      <div className="lg:w-7/12 w-full flex flex-col justify-center lg:justify-start lg:items-start items-center">
        <h1 className="xl:text-7xl lg:text-6xl text-5xl text-secondary lg:max-w-3xl font-bold">
          Shop <span className="text-primary">for</span> daily fruits &{" "}
      ...
      <img
        src={hero}
        alt="fruit basket"
        className="xl:w-[543px] xl:h-[623px] w-[420px] h-[400px]"
      />
    </main>
  );
};
