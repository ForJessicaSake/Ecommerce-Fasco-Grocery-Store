...
const Delivery = () => {
  return (
    <main
      className="mx-auto container bg-[#e1f5fa] py-10 my-14 lg:my-20"
      id="delivery"
    >
      <div
        data-aos="fade-right"
        className="flex md:flex-row flex-col-reverse md:justify-between justify-center items-center lg:px-10 px-5"
      >
